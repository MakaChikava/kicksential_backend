"""
Django settings for kicksential project.
...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-m5jczq2vi-sb(-kw*7168@jc=b6r5f^7rl9^ea5(tgg^mq=86s')

DEBUG = os.environ.get('DEBUG', 'True').lower() in ('true', '1', 'yes')

ALLOWED_HOSTS = os.environ.get('ALLOWED_HOSTS', 'localhost,127.0.0.1,.vercel.app').split(',')
# Add Vercel URL if deployed
...
WSGI_APPLICATION = 'kicksential.wsgi.application'
